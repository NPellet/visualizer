...
BI.Forms.Fields.Datetime.prototype = {
	...
	_setValueText: function(index, date) {
		...
		var str = '<nobr>' + this._addZero(date.getDate()) + " " + BI.lang.months[date.getMonth()] + " " + date.getFullYear() + " " + this._addZero(date.getHours()) + ":" + this._addZero(date.getMinutes()) + ":" + this._addZero(date.getSeconds()) + '<nobr>';
