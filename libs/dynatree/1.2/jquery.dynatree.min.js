...
//				delete tn;  // JSLint complained
	...
	removeChildren: function(isRecursiveCall, retainPersistence, doNotRemoveLazy) {
...
//				delete tn;  JSLint complained
			...
			this.childList = newList.length > 0 ? newList : null;
...
//		this.tree.logDebug("%s.addChild(%o, %o)", this, obj, beforeNode);
	...
	appendAjax: function(ajaxOptions) {
		var self = this;
		this.removeChildren(false, true, true);
		this.setLazyNodeStatus(DTNodeStatus_Loading);
