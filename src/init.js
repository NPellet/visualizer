...
require(['jquery', 'src/main/datas', 'src/main/entrypoint', 'uri/URI.fragmentQuery', 'components/bluebird/js/browser/bluebird', 'lib/IndexedDBShim/IndexedDBShim'], function($, Datas, EntryPoint, URI, Promise) {
