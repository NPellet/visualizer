...
for (var i = 0; i < 37; i++) if (this.shapes[i] != null) this.setShapePropertyBs (i, "refreshTrajectories", [Imodel, bs, mat], bsModelAtoms);
...
for (var i = 16; i < 30; ++i) this.getShapePropertyData (i, "getNames", [map, bDollar]);
