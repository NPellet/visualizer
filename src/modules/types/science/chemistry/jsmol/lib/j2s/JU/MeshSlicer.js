...
case 1:
case 6:
if (ptCenters == null) p = [this.interpolatePoint (vA, vB, -d1, d2, valA, valB, 0), this.interpolatePoint (vA, vC, -d1, d3, valA, valC, 1)];
 else p = [this.interpolateSphere (vA, vB, -d1, -d2, absD, valA, valB, 0), this.interpolateSphere (vA, vC, -d1, -d3, absD, valA, valC, 1)];
break;
case 2:
case 5:
if (ptCenters == null) p = [this.interpolatePoint (vB, vA, -d2, d1, valB, valA, 1), this.interpolatePoint (vB, vC, -d2, d3, valB, valC, 0)];
 else p = [this.interpolateSphere (vB, vA, -d2, -d1, absD, valB, valA, 1), this.interpolateSphere (vB, vC, -d2, -d3, absD, valB, valC, 0)];
break;
case 3:
case 4:
if (ptCenters == null) p = [this.interpolatePoint (vC, vA, -d3, d1, valC, valA, 0), this.interpolatePoint (vC, vB, -d3, d2, valC, valB, 1)];
 else p = [this.interpolateSphere (vC, vA, -d3, -d1, absD, valC, valA, 0), this.interpolateSphere (vC, vB, -d3, -d2, absD, valC, valB, 1)];
break;
}
this.doClear = true;
