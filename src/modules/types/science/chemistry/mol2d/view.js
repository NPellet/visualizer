define(['modules/default/defaultview','src/util/api','src/util/util','src/util/datatraversing', 'src/util/typerenderer', 'ChemDoodle'], function(Default, API, Util, Traversing, Renderer) {
