    ...
    window.addEventListener('message', function (event) {
        ...
        switch (message.type) {
            case 'ready':
                ...
                break;
            case 'onChange':
                view.module.controller.onChange(message.message.mol, message.message.molV3, message.message.smiles, message.message.jme, message.message.svg, message.message.action);
                break;
            case 'doHighlight':
