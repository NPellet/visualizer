    ...
    function (Default, Util, API, Renderer, Color, sprintf, _) {
        ...
        $.extend(true, View.prototype, Default, {
            ...
            blank: {
                value: function () {
                    if (this.module.getConfigurationCheckbox('append', 'yes')) {
                        var maxEntries = this.module.getConfiguration(
                            'maxEntries'
                        );
            ...
            update: {
                ...
                value: function (varValue, varName) {
                    if (
                        varValue instanceof DataNumber ||
            ...
            renderAll: function () {
                ...
                var that = this,
                    ...
                    rendererOptions =
                        Util.evalOptions(
                            this.module.getConfiguration('rendererOptions')
                        ) || {};
                ...
                if (sprintfVal) {
                    if (!forceType) {
                        ...
                        Promise.all(prom).then(function (rendered) {
                            ...
                            that.fillWithVal(
                                sprintf.sprintf.apply(null, args),
                                {
                                    forceType: 'html'
                                }
                            );
                        ...
                        try {
                            ...
                            args = args.concat(
                                that.values.map(v =>
                                    DataObject.resurrect(v.value.get())
                                )
                            );
        ...
        function triggerChange(e) {
            ...
            let editSearchRegexp = this.module.getConfiguration(
                'editSearchRegexp'
            );
