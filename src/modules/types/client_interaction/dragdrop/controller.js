    ...
    function (
        ...
        Controller.prototype.treatString = function (item, meta) {
            ...
            item.getAsString(str => {
                if (
                    this.module.getConfigurationCheckbox('askFilename', 'yes')
                ) {
                    ui
                        .enterValue({
        ...
        Controller.prototype.checkMetadata = function (
            item,
            cfg,
            getMime,
            name
            ...
            for (var i = 0, l = cfg.length; i < l; i++) {
                ...
                if (filter === 'ext') {
                    ...
                    if (
                        extensions === '*' ||
                        extensions.split(',').indexOf(ext) !== -1
                    ) {
                        lineCfg = cfg[i];
                        break;
                    }
