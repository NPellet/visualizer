...
Clazz.load (["javajs.api.BytePoster", "java.util.Hashtable"], "J.viewer.FileManager", ["java.io.BufferedInputStream", "$.BufferedReader", "$.ByteArrayInputStream", "java.lang.Boolean", "java.net.URL", "$.URLEncoder", "JU.AU", "$.Base64", "$.List", "$.PT", "$.SB", "J.api.Interface", "J.io.FileReader", "$.JmolBinary", "J.util.Logger", "$.Txt", "J.viewer.Viewer"], function () {
...
return (Clazz.instanceOf (o, String) ? J.io.JmolBinary.getBufferedReaderForString (o) : o);
...
data[1] = t;
return false;
}if (checkProtected && data[0].startsWith ("file:") && (data[0].indexOf ("/.") >= 0 || data[0].lastIndexOf ('.') < data[0].lastIndexOf ('/') || data[0].lastIndexOf (":/") == data[0].lastIndexOf ('/') - 1)) {
