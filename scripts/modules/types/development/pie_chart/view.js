define(['modules/defaultview','util/datatraversing','util/api','util/util','libs/flot/jquery.flot','libs/flot/jquery.flot.pie'], function(Default, Traversing, API, Util) {
