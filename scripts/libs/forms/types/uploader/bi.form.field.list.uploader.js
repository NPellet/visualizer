...
BI.Forms.Fields.List.Uploader = function(main) {
	this.main = main;
}

BI.Forms.Fields.List.Uploader.prototype = new BI.Forms.Fields.Uploader();

$.extend(BI.Forms.Fields.List.Uploader.prototype, {
