...
BI.Forms.Fields.List.Textarea = function(main) {
	this.main = main;	
}

BI.Forms.Fields.List.Textarea.prototype = new BI.Forms.Fields.Text();
BI.Forms.Fields.List.Textarea.prototype.buildHtml = BI.Forms.FieldGeneric.buildHtml;
BI.Forms.Fields.List.Textarea.prototype.addField = function() {
...
BI.Forms.Fields.List.Textarea.prototype.removeField = BI.Forms.FieldGeneric.removeField;

BI.Forms.Fields.List.Textarea.prototype.initHtml = function() {
