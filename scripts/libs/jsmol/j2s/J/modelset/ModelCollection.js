...
if (this.vibrations != null) for (var i = this.atomCount; --i >= 0; ) if ((modelIndex < 0 || this.atoms[i].modelIndex == modelIndex) && this.vibrations[i] != null && this.vibrations[i].length () > 0 && (tok == 0 || (tok == 135270424) == (Clazz.instanceOf (this.vibrations[i], J.api.JmolModulationSet)))) return i;
...
if (wasEnabled) a.add (ms.getPrevSetting ());
...
this.bsModulated.setBitTo (i, ms.isEnabled ());
}
}, "JU.BS,~B,~N");
